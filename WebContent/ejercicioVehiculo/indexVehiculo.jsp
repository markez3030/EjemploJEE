	...
	<article>
		...
		<p>
			...
			Si esta todo <strong>bien</strong>, se <strong>crea el
				vehiculo</strong> y se muestra por pantalla.<br /> Mapping del Servlet:<b>/ejercicioVehiculo/vehiculo</b><br />
		</p>
		...
		<article id="impresionDatos">
			...
			%>
			<div class="alert alert-success" role="alert">El vehiculo ha
				sido creado de manera correcta</div>
			<%
