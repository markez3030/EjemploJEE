	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="page-scroll"><a href="menu-del-dia.jsp">Menu del
						Dia</a></li>
...
<header>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<img class="img-responsive logo-home" src="../img/profile.png"
					alt="logotipo de Web Recetas">
	...
	<div class="container">
		...
		<div class="row">
			<%
				...
				recetas.add(new Receta("Marmitako"));
				recetas.add(new Receta("Tortilla Patatas"));
				recetas.add(new Receta("Solomillo"));
				recetas.add(new Receta("Txipirones en su pinta"));
				recetas.add(new Receta("Bacalo al pil pil"));
			...
			<div class="col-sm-4 portfolio-item">
				<a href="#portfolioModal<%=i%>" class="portfolio-link"
					...
					</div> <img src="<%=receta.getImagen()%>" class="img-responsive"
					alt="<%=receta.getTitulo()%>">
				</a>
			</div>
			<!-- end:receta -->
			<%
	...
	<div class="container" id="ejercicios">
		...
		<div class="row">
			...
			<ul>
				...
				<li><a href="ejercicios/primer-controlador.jsp">Controlador
						o Servlet [GET y POST]</a></li>
				<li><a href="ejercicios/crear-vehiculo.jsp">Crear Vehiculo
						y Excepciones Personalizadas</a></li>
			</ul>
